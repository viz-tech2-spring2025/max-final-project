...
import { LitElement as b, createEvent as s, safeClassMap as a } from "@arcgis/lumina";
import { a as o } from "../../chunks/dom.js";
import { c as u } from "../../chunks/component.js";
import { u as m, I as g } from "../../chunks/interactive.js";
import { i as f } from "../../chunks/key.js";
...
class w extends b {
  ...
  async setFocus() {
    await u(this), this.disabled || this.containerEl.value?.focus();
  }
  // #endregion
  // #region Lifecycle
  updated() {
  ...
  keyDownHandler(e) {
    if (e.target === this.containerEl.value && !this.selectable && !this.disabled)
      if (f(e.key) && this.selectionMode !== "none")
  ...
  renderSelectionIcon() {
    const e = this.selectionMode === "multiple" && this.selected ? r.selected : this.selectionMode === "multiple" ? r.unselected : this.selected ? r.selectedSingle : r.unselectedSingle;
  ...
  render() {
    const e = this.thumbnailPosition.startsWith("inline"), n = this.thumbnailPosition.endsWith("start"), l = this.selectionMode === "multiple" ? "checkbox" : this.selectionMode !== "none" ? "radio" : void 0;
    return g({ disabled: this.disabled, children: i`<div .ariaChecked=${this.selectionMode !== "none" ? this.selected : void 0} .ariaLabel=${this.label} class=${a({ [t.contentWrapper]: !0, inline: e })} @click=${this.cardBodyClickHandler} @keydown=${this.keyDownHandler} .role=${l} .tabIndex=${!this.selectable || this.disabled ? 0 : -1} ${p(this.containerEl)}>${this.loading ? i`<div aria-live=polite class="calcite-card-loader-container"><calcite-loader .label=${this.messages.loading}></calcite-loader></div>` : null}${n && this.renderThumbnail() || ""}<section .ariaBusy=${this.loading} class=${a({ [t.container]: !0 })}>${this.renderHeader()}<div class=${a({
      [t.cardContent]: !0,
