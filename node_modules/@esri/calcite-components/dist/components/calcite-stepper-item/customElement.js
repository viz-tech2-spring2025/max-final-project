...
import { nothing as n, html as o } from "lit";
import { createRef as c, ref as d } from "lit-html/directives/ref.js";
import { LitElement as p, createEvent as r, setAttribute as h, safeClassMap as t } from "@arcgis/lumina";
import { u as m, I as u } from "../../chunks/interactive.js";
import { n as s } from "../../chunks/locale.js";
import { c as b, i as g } from "../../chunks/component.js";
...
class z extends p {
  ...
  async setFocus() {
    await b(this), (this.layout === "vertical" ? this.el : this.headerEl.value)?.focus();
  }
  async load() {
  ...
  updated() {
    m(this), h(this.el, "tabindex", this.disabled || this.layout === "horizontal" ? null : 0);
  }
  // #endregion
  ...
  handleItemClick(e) {
    this.disabled || g(this.el) || this.layout === "horizontal" && e.composedPath().some((a) => a.classList?.contains("stepper-item-content")) || this.emitUserRequestedItem();
  }
