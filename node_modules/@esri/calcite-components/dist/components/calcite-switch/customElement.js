...
import { LitElement as r, createEvent as s, safeClassMap as t } from "@arcgis/lumina";
import { b as l } from "../../chunks/dom.js";
import { c as n, d, H as h } from "../../chunks/form.js";
import { u as b, I as p } from "../../chunks/interactive.js";
import { i as m } from "../../chunks/key.js";
import { c as u, d as k, g as v } from "../../chunks/label.js";
import { c as w } from "../../chunks/component.js";
...
class y extends r {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.checked = !1, this.disabled = !1, this.scale = "m", this.calciteSwitchChange = s({ cancelable: !1 }), this.listen("click", this.clickHandler), this.listen("keydown", this.keyDownHandler);
  }
  static {
  ...
  async setFocus() {
    await w(this), l(this.switchEl);
  }
  connectedCallback() {
    super.connectedCallback(), u(this), n(this);
  }
  updated() {
    b(this);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), k(this), d(this);
  }
  // #endregion
  ...
  keyDownHandler(e) {
    !this.disabled && m(e.key) && (this.toggle(), e.preventDefault());
  }
  onLabelClick() {
  ...
  // #region Rendering
  render() {
    return p({ disabled: this.disabled, children: a`<div .ariaChecked=${this.checked} .ariaLabel=${v(this)} class=${t(o.container)} role=switch tabindex=0 ${c(this.setSwitchEl)}><div class=${t(o.track)}><div class=${t(o.handle)}></div></div>${h({ component: this })}</div>` });
  }
}
i("calcite-switch", y);
export {
