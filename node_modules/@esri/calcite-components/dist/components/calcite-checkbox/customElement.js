...
import { svg as l, html as r } from "lit-html";
...
import { c as b, d as m, H as u } from "../../chunks/form.js";
...
import { c as C } from "../../chunks/component.js";
...
class I extends d {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), x(this), m(this);
  }
  // #endregion
  ...
  render() {
    ...
    return f({ disabled: this.disabled, children: r`<div .ariaChecked=${this.checked} .ariaLabel=${y(this)} class=${o({
      [s.toggle]: !0,
      [c.rtl]: e
    })} @blur=${this.onToggleBlur} @focus=${this.onToggleFocus} role=checkbox tabindex=${(this.disabled ? void 0 : 0) ?? i} ${h(this.toggleEl)}><svg aria-hidden=true class=${o(s.check)} viewBox="0 0 16 16">${l`<path d=${this.getPath() ?? i} />`}</svg><slot></slot></div>${u({ component: this })}` });
  }
}
