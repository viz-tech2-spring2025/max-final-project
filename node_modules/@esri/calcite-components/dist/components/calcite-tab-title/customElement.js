import { i as f, c as v } from "../../chunks/runtime.js";
import { keyed as g } from "lit-html/directives/keyed.js";
import { html as a, nothing as x } from "lit";
import { createRef as k, ref as b } from "lit-html/directives/ref.js";
import { LitElement as y, createEvent as o, safeClassMap as n, setAttribute as s } from "@arcgis/lumina";
import { n as T, g as h, t as z } from "../../chunks/dom.js";
import { g as I } from "../../chunks/guid.js";
import { u as C, I as E } from "../../chunks/interactive.js";
import { c as u } from "../../chunks/observers.js";
import { g as r } from "../../chunks/component.js";
...
class H extends y {
  ...
  async getTabIndex() {
    return Array.prototype.indexOf.call(T(this.el.parentElement.children).filter((t) => t.matches("calcite-tab-title")), this.el);
  }
  /**
   * @param tabIds
   * @param titleIds
  ...
  async load() {
    f() && this.updateHasText(), this.tab && this.selected && this.activateTab(!1);
  }
  willUpdate(t) {
  ...
  render() {
    ...
    return s(this.el, "aria-controls", this.controls), this.el.ariaSelected = z(this.selected), s(this.el, "id", c), this.el.role = "tab", s(this.el, "tabIndex", this.selected && !this.disabled ? 0 : -1), E({ disabled: this.disabled, children: a`<div class=${n({
      [e.container]: !0,
  ...
  renderCloseButton() {
    ...
    return t ? g(e.closeButton, a`<button .ariaLabel=${i.close} class=${n(e.closeButton)} @click=${this.closeClickHandler} title=${i.close ?? x} type=button ${b(this.closeButtonEl)}><calcite-icon .icon=${F.close} .scale=${r(this.scale)}></calcite-icon></button>`) : null;
  }
}
v("calcite-tab-title", H);
export {
  H as TabTitle
};
