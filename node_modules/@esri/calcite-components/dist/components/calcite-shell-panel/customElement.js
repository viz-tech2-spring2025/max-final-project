import { C as y, c as N } from "../../chunks/runtime.js";
import { keyed as z } from "lit-html/directives/keyed.js";
import { ref as S } from "lit-html/directives/ref.js";
import { html as g } from "lit";
import { LitElement as K, createEvent as E, safeClassMap as b, safeStyleMap as B } from "@arcgis/lumina";
import { i as W, g as M, s as D, a as L } from "../../chunks/dom.js";
import { c as A } from "../../chunks/math.js";
import { g as P } from "../../chunks/dynamicClasses.js";
...
class R extends K {
  constructor() {
    super(...arguments), this.actionBars = [], this.contentHeightMax = null, this.contentHeightMin = null, this.contentWidthMax = null, this.contentWidthMin = null, this.initialClientX = null, this.initialClientY = null, this.initialContentHeight = null, this.initialContentWidth = null, this.separatorPointerDown = (e) => {
      ...
      e.preventDefault();
      const { el: t, layout: i, initialContentWidth: n, initialContentHeight: m, position: a, initialClientX: w, initialClientY: d } = this, l = i === "horizontal" ? e.clientY - d : e.clientX - w, s = i === "vertical" && M(t) === "rtl" ? -1 : 1, x = a === "end" ? -s * l : s * l;
      i === "horizontal" ? this.setContentHeight(m + x) : this.setContentWidth(n + x);
    ...
    }, this.step = 1, this.stepMultiplier = 10, this.contentHeight = null, this.contentWidth = null, this.hasHeader = !1, this.collapsed = !1, this.displayMode = "dock", this.layout = "vertical", this.messages = V(), this.position = "start", this.resizable = !1, this.widthScale = "m", this.calciteInternalShellPanelResizeEnd = E({ cancelable: !1 }), this.calciteInternalShellPanelResizeStart = E({ cancelable: !1 });
  }
  static {
  ...
  getKeyAdjustedSize(e) {
    const { key: t } = e, { el: i, step: n, stepMultiplier: m, layout: a, contentWidthMin: w, contentWidthMax: d, initialContentWidth: l, initialContentHeight: s, contentHeightMin: x, contentHeightMax: h, position: o } = this, c = n * m;
    [
      "ArrowUp",
      "ArrowDown",
      "ArrowLeft",
    ...
    const k = M(i), r = ["ArrowLeft", "ArrowRight"], p = ["ArrowDown", "ArrowUp"], f = k === "rtl" && r.includes(t) ? -1 : 1;
    if (a === "horizontal" ? o === "end" ? t === p[1] || t === r[0] : t === p[0] || t === r[1] : t === p[1] || (o === "end" ? t === r[0] : t === r[1])) {
      const v = e.shiftKey ? c : n;
      return a === "horizontal" ? s + f * v : l + f * v;
    }
    if (a === "horizontal" ? o === "end" ? t === p[0] || t === r[0] : t === p[1] || t === r[1] : t === p[0] || (o === "end" ? t === r[1] : t === r[0])) {
      const v = e.shiftKey ? c : n;
      return a === "horizontal" ? s - f * v : l - f * v;
    }
    return t === "Home" && a === "horizontal" && typeof x == "number" ? x : t === "Home" && a === "vertical" && typeof w == "number" ? w : t === "End" && a === "horizontal" && typeof h == "number" ? h : t === "End" && a === "vertical" && typeof d == "number" ? d : t === "PageDown" ? a === "horizontal" ? s - c : l - c : t === "PageUp" ? a === "horizontal" ? s + c : l + c : null;
  }
  ...
  handleActionBarSlotChange(e) {
    const t = D(e).filter((i) => i?.matches("calcite-action-bar"));
  ...
  // #region Rendering
  renderHeader() {
    return z("header", g`<div class=${b(u.contentHeader)} .hidden=${!this.hasHeader}><slot name=${$.header} @slotchange=${this.handleHeaderSlotChange}></slot></div>`);
  }
  render() {
    const { collapsed: e, position: t, initialContentWidth: i, initialContentHeight: n, contentWidth: m, contentWidthMax: a, contentWidthMin: w, contentHeight: d, contentHeightMax: l, contentHeightMin: s, resizable: x, layout: h, displayMode: o } = this, c = M(this.el), C = o !== "float-content" && o !== "float" && x, k = C ? h === "horizontal" ? d ? { height: `${d}px` } : null : m ? { width: `${m}px` } : null : null, r = !e && C ? z("separator", g`<div .ariaLabel=${this.messages.resize} .ariaOrientation=${h === "horizontal" ? "vertical" : "horizontal"} .ariaValueMax=${h == "horizontal" ? l : a} .ariaValueMin=${h == "horizontal" ? s : w} .ariaValueNow=${h == "horizontal" ? d ?? n : m ?? i} class=${b(u.separator)} @keydown=${this.separatorKeyDown} role=separator tabindex=0 touch-action=none ${S(this.connectSeparator)}></div>`) : null, p = () => h === "horizontal" ? t === "start" ? y.calciteAnimateInDown : y.calciteAnimateInUp : c === "ltr" && t === "end" || c === "rtl" && t === "start" ? y.calciteAnimateInLeft : y.calciteAnimateInRight, f = z("content", g`<div class=${b({
      [y.rtl]: c === "rtl",
      [u.content]: !0,
      [u.contentOverlay]: o === "overlay",
      [u.floatContent]: o === "float-content" || o === "float",
      [y.calciteAnimate]: o === "overlay",
      [p()]: o === "overlay",
    ...
    })} .hidden=${e} style=${B(k)} ${S(this.storeContentEl)}>${this.renderHeader()}<div class=${b(u.contentBody)}><slot></slot></div>${r}</div>`), H = [z("action-bar", g`<slot name=${$.actionBar} @slotchange=${this.handleActionBarSlotChange}></slot>`), f];
    return t === "end" && H.reverse(), g`<div class=${b({ [u.container]: !0, [u.floatAll]: o === "float-all" })}>${H}</div>`;
  }
}
N("calcite-shell-panel", R);
export {
  R as ShellPanel
};
