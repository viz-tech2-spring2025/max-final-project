...
import { LitElement as d, createEvent as h, safeClassMap as i } from "@arcgis/lumina";
import { r as m, t as g } from "../../chunks/dom.js";
...
class v extends d {
  ...
  // #region Rendering
  renderIcon(e, t = !1) {
    return e ? l`<calcite-icon class=${i({
      [o.icon]: !0,
      [o.iconSolo]: t
    })} .flipRtl=${this.iconFlipRtl} .icon=${e} scale=s></calcite-icon>` : null;
  }
  render() {
    const { appearance: e, checked: t, layout: n, scale: a, value: r } = this;
    return this.el.ariaChecked = g(t), this.el.ariaLabel = r, this.el.role = "radio", l`<label class=${i({
      [o.label]: !0,
      [o.labelScale(a)]: !0,
  ...
  renderContent() {
    const { hasSlottedContent: e, iconEnd: t, iconStart: n } = this, a = n || t;
    return !e && a ? [this.renderIcon(a, !0), l`<slot @slotchange=${this.handleSlotChange}></slot>`] : [
      this.renderIcon(n),
      l`<slot @slotchange=${this.handleSlotChange}></slot>`,
      l`<slot name=${u.input}></slot>`,
      this.renderIcon(t)
    ];
  }
}
s("calcite-segmented-control-item", v);
export {
