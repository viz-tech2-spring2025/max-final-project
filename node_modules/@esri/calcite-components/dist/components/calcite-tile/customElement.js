...
import { LitElement as $, createEvent as u, safeClassMap as n, nothing as y } from "@arcgis/lumina";
import { u as S, I as E } from "../../chunks/interactive.js";
import { a as T } from "../../chunks/dom.js";
import { c as A } from "../../chunks/component.js";
...
class M extends $ {
  ...
  async setFocus() {
    await A(this), !this.disabled && this.interactive && this.containerEl?.focus();
  }
  updated() {
    S(this);
  }
  ...
  renderSelectionIcon() {
    ...
    if (c === "icon" && a !== "none")
      return o`<calcite-icon class=${n(t.selectionIcon)} .icon=${e ? a === "multiple" ? s.selectedMultiple : s.selectedSingle : a === "multiple" ? s.unselectedMultiple : s.unselectedSingle} scale=s></calcite-icon>`;
  }
  renderTile() {
    const { description: e, disabled: c, hasContentBottom: a, hasContentEnd: g, hasContentStart: m, hasContentTop: f, heading: l, icon: r, iconFlipRtl: x, interactive: i, selectionMode: h } = this, k = l && r && !e, v = !!this.href || !i, p = h === "multiple" && i ? "checkbox" : h !== "none" && i ? "radio" : i ? "button" : void 0, b = !!(e || g || m || l || r), z = !b && f && a;
