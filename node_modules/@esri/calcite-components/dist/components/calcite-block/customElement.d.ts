...
export declare class Block extends LitElement {
    ...
    readonly calciteBlockBeforeClose: TargetedEvent<this, undefined>;
    /** Fires when the component is added to the DOM but not rendered, and before the opening transition begins. */
    readonly calciteBlockBeforeOpen: TargetedEvent<this, undefined>;
    /** Fires when the component is closed and animation is complete. */
    readonly calciteBlockClose: TargetedEvent<this, undefined>;
    /** Fires when the component is open and animation is complete. */
    readonly calciteBlockOpen: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is requested to be closed and before the closing transition begins. */
    readonly calciteBlockSortHandleBeforeClose: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is added to the DOM but not rendered, and before the opening transition begins. */
    readonly calciteBlockSortHandleBeforeOpen: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is closed and animation is complete. */
    readonly calciteBlockSortHandleClose: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is open and animation is complete. */
    readonly calciteBlockSortHandleOpen: TargetedEvent<this, undefined>;
    /**
     ...
     */
    readonly calciteBlockToggle: TargetedEvent<this, undefined>;
}
