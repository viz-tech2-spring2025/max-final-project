...
import { html as a, nothing as k } from "lit";
import { createRef as m, ref as d } from "lit-html/directives/ref.js";
import { LitElement as y, createEvent as l, setAttribute as p, safeClassMap as o } from "@arcgis/lumina";
import { getNearestOverflowAncestor as b } from "@floating-ui/utils/dom";
import { h as w, s as u, a as s, o as g } from "../../chunks/dom.js";
import { c as z, g as C } from "../../chunks/component.js";
import { c as f } from "../../chunks/observers.js";
import { o as $ } from "../../chunks/openCloseComponent.js";
import { l as O } from "../../chunks/logger.js";
...
class M extends y {
  ...
  // #region Rendering
  render() {
    return p(this.el, "aria-describedby", this.contentId), p(this.el, "aria-labelledby", this.titleId), this.el.ariaModal = "true", this.el.role = "dialog", a`<div class=${o({
      [t.container]: !0,
  ...
  renderCloseButton() {
    return this.closeButtonDisabled ? null : h("button", a`<button .ariaLabel=${this.messages.close} class=${o(t.close)} @click=${this.handleCloseClick} title=${this.messages.close ?? k} ${d(this.closeButtonEl)}><calcite-icon .icon=${B.close} .scale=${C(this.scale)}></calcite-icon></button>`);
  }
  renderStyle() {
