...
import { LitElement as n, nothing as c, safeClassMap as i } from "@arcgis/lumina";
...
class s extends n {
  ...
  render() {
    const { scale: t } = this;
    return a`<div aria-label=${this.label ?? this.heading ?? c} class=${i({
      [e.container]: !0,
...
o("calcite-autocomplete-item-group", s);
export {
