...
interface ReactCalciteActionBar extends Partial<Pick<ActionBar, 'actionsEndGroupLabel' | 'expandDisabled' | 'expanded' | 'layout' | 'messageOverrides' | 'overflowActionsDisabled' | 'overlayPositioning' | 'position' | 'scale'>>, HTMLProps<HTMLCalciteActionBarElement> {
...
interface ReactCalciteCombobox extends Required<Pick<Combobox, 'label'>>, Partial<Pick<Combobox, 'allowCustomValues' | 'clearDisabled' | 'disabled' | 'filterProps' | 'filterText' | 'flipPlacements' | 'form' | 'maxItems' | 'messageOverrides' | 'name' | 'open' | 'overlayPositioning' | 'placeholder' | 'placeholderIcon' | 'placeholderIconFlipRtl' | 'readOnly' | 'required' | 'scale' | 'selectionDisplay' | 'selectionMode' | 'status' | 'validationIcon' | 'validationMessage' | 'value'>>, HTMLProps<HTMLCalciteComboboxElement> {
...
interface ReactCalciteFlowItem extends Partial<Pick<FlowItem, 'beforeBack' | 'beforeClose' | 'closable' | 'closed' | 'collapsed' | 'collapsible' | 'description' | 'disabled' | 'heading' | 'headingLevel' | 'loading' | 'menuOpen' | 'messageOverrides' | 'overlayPositioning' | 'scale' | 'selected' | 'showBackButton'>>, HTMLProps<HTMLCalciteFlowItemElement> {
...
interface ReactCalcitePanel extends Partial<Pick<Panel, 'beforeClose' | 'closable' | 'closed' | 'collapsed' | 'collapsible' | 'description' | 'disabled' | 'heading' | 'headingLevel' | 'loading' | 'menuFlipPlacements' | 'menuOpen' | 'menuPlacement' | 'messageOverrides' | 'overlayPositioning' | 'scale'>>, HTMLProps<HTMLCalcitePanelElement> {
