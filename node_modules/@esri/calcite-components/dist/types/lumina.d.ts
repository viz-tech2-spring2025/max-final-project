...
interface LuminaCalciteAccordion extends Partial<Pick<Accordion, 'appearance' | 'iconPosition' | 'iconType' | 'scale' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteAccordionElement> {
}

interface LuminaCalciteAccordionItem extends Partial<Pick<AccordionItem, 'description' | 'expanded' | 'heading' | 'iconEnd' | 'iconFlipRtl' | 'iconStart'>>, h.JSX.HTMLAttributes<HTMLCalciteAccordionItemElement> {
}

interface LuminaCalciteAction extends Required<Pick<Action, 'text'>>, Partial<Pick<Action, 'active' | 'alignment' | 'appearance' | 'compact' | 'disabled' | 'icon' | 'iconFlipRtl' | 'indicator' | 'label' | 'loading' | 'messageOverrides' | 'scale' | 'textEnabled'>>, h.JSX.HTMLAttributes<HTMLCalciteActionElement> {
}

interface LuminaCalciteActionBar extends Partial<Pick<ActionBar, 'actionsEndGroupLabel' | 'expandDisabled' | 'expanded' | 'layout' | 'messageOverrides' | 'overflowActionsDisabled' | 'overlayPositioning' | 'position' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteActionBarElement> {
  oncalciteActionBarToggle?: EventHandler<HTMLCalciteActionBarElement["calciteActionBarToggle"]>;
}

interface LuminaCalciteActionGroup extends Partial<Pick<ActionGroup, 'columns' | 'expanded' | 'label' | 'layout' | 'menuFlipPlacements' | 'menuOpen' | 'menuPlacement' | 'messageOverrides' | 'overlayPositioning' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteActionGroupElement> {
}

interface LuminaCalciteActionMenu extends Required<Pick<ActionMenu, 'label'>>, Partial<Pick<ActionMenu, 'appearance' | 'expanded' | 'flipPlacements' | 'open' | 'overlayPositioning' | 'placement' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteActionMenuElement> {
  oncalciteActionMenuOpen?: EventHandler<HTMLCalciteActionMenuElement["calciteActionMenuOpen"]>;
}

interface LuminaCalciteActionPad extends Partial<Pick<ActionPad, 'actionsEndGroupLabel' | 'expandDisabled' | 'expanded' | 'layout' | 'messageOverrides' | 'overlayPositioning' | 'position' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteActionPadElement> {
  oncalciteActionPadToggle?: EventHandler<HTMLCalciteActionPadElement["calciteActionPadToggle"]>;
}

interface LuminaCalciteAlert extends Required<Pick<Alert, 'label'>>, Partial<Pick<Alert, 'autoClose' | 'autoCloseDuration' | 'icon' | 'iconFlipRtl' | 'kind' | 'messageOverrides' | 'numberingSystem' | 'open' | 'placement' | 'queue' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteAlertElement> {
...
interface LuminaCalciteAutocomplete extends Partial<Pick<Autocomplete, 'alignment' | 'autocomplete' | 'disabled' | 'flipPlacements' | 'form' | 'icon' | 'iconFlipRtl' | 'inputValue' | 'label' | 'loading' | 'maxLength' | 'messageOverrides' | 'minLength' | 'name' | 'open' | 'overlayPositioning' | 'pattern' | 'placeholder' | 'placement' | 'prefixText' | 'readOnly' | 'required' | 'scale' | 'status' | 'suffixText' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteAutocompleteElement> {
...
interface LuminaCalciteAutocompleteItem extends Required<Pick<AutocompleteItem, 'heading'>>, Partial<Pick<AutocompleteItem, 'description' | 'disabled' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteAutocompleteItemElement> {
}

interface LuminaCalciteAutocompleteItemGroup extends Required<Pick<AutocompleteItemGroup, 'heading'>>, Partial<Pick<AutocompleteItemGroup, 'label'>>, h.JSX.HTMLAttributes<HTMLCalciteAutocompleteItemGroupElement> {
}

interface LuminaCalciteAvatar extends Partial<Pick<Avatar, 'fullName' | 'label' | 'scale' | 'thumbnail' | 'userId' | 'username'>>, h.JSX.HTMLAttributes<HTMLCalciteAvatarElement> {
}

interface LuminaCalciteBlock extends Partial<Pick<Block, 'collapsible' | 'description' | 'disabled' | 'dragDisabled' | 'dragHandle' | 'expanded' | 'heading' | 'headingLevel' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'loading' | 'menuFlipPlacements' | 'menuPlacement' | 'messageOverrides' | 'open' | 'overlayPositioning' | 'sortHandleOpen' | 'status'>>, h.JSX.HTMLAttributes<HTMLCalciteBlockElement> {
...
interface LuminaCalciteBlockGroup extends Required<Pick<BlockGroup, 'label'>>, Partial<Pick<BlockGroup, 'canPull' | 'canPut' | 'disabled' | 'dragEnabled' | 'group' | 'loading'>>, h.JSX.HTMLAttributes<HTMLCalciteBlockGroupElement> {
...
interface LuminaCalciteBlockSection extends Partial<Pick<BlockSection, 'expanded' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'messageOverrides' | 'open' | 'status' | 'text' | 'toggleDisplay'>>, h.JSX.HTMLAttributes<HTMLCalciteBlockSectionElement> {
  oncalciteBlockSectionToggle?: EventHandler<HTMLCalciteBlockSectionElement["calciteBlockSectionToggle"]>;
}

interface LuminaCalciteButton extends Partial<Pick<Button, 'alignment' | 'appearance' | 'disabled' | 'download' | 'form' | 'href' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'kind' | 'label' | 'loading' | 'messageOverrides' | 'name' | 'rel' | 'round' | 'scale' | 'splitChild' | 'target' | 'type' | 'width'>>, h.JSX.HTMLAttributes<HTMLCalciteButtonElement> {
}

interface LuminaCalciteCard extends Partial<Pick<Card, 'disabled' | 'label' | 'loading' | 'messageOverrides' | 'selectable' | 'selected' | 'thumbnailPosition'>>, h.JSX.HTMLAttributes<HTMLCalciteCardElement> {
  oncalciteCardSelect?: EventHandler<HTMLCalciteCardElement["calciteCardSelect"]>;
}

interface LuminaCalciteCardGroup extends Required<Pick<CardGroup, 'label'>>, Partial<Pick<CardGroup, 'disabled' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteCardGroupElement> {
  oncalciteCardGroupSelect?: EventHandler<HTMLCalciteCardGroupElement["calciteCardGroupSelect"]>;
}

interface LuminaCalciteCarousel extends Required<Pick<Carousel, 'label'>>, Partial<Pick<Carousel, 'arrowType' | 'autoplay' | 'autoplayDuration' | 'controlOverlay' | 'disabled' | 'messageOverrides'>>, h.JSX.HTMLAttributes<HTMLCalciteCarouselElement> {
...
interface LuminaCalciteCarouselItem extends Required<Pick<CarouselItem, 'label'>>, Partial<Pick<CarouselItem, 'selected'>>, h.JSX.HTMLAttributes<HTMLCalciteCarouselItemElement> {
}

interface LuminaCalciteCheckbox extends Partial<Pick<Checkbox, 'checked' | 'disabled' | 'form' | 'indeterminate' | 'label' | 'name' | 'required' | 'scale' | 'status' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteCheckboxElement> {
  oncalciteCheckboxChange?: EventHandler<HTMLCalciteCheckboxElement["calciteCheckboxChange"]>;
}

interface LuminaCalciteChip extends Required<Pick<Chip, 'label'>>, Partial<Pick<Chip, 'appearance' | 'closable' | 'closed' | 'closeOnDelete' | 'disabled' | 'icon' | 'iconFlipRtl' | 'kind' | 'messageOverrides' | 'scale' | 'selected' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteChipElement> {
...
interface LuminaCalciteChipGroup extends Required<Pick<ChipGroup, 'label'>>, Partial<Pick<ChipGroup, 'disabled' | 'scale' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteChipGroupElement> {
  oncalciteChipGroupSelect?: EventHandler<HTMLCalciteChipGroupElement["calciteChipGroupSelect"]>;
}

interface LuminaCalciteColorPicker extends Partial<Pick<ColorPicker, 'allowEmpty' | 'alphaChannel' | 'channelsDisabled' | 'clearable' | 'disabled' | 'format' | 'hexDisabled' | 'messageOverrides' | 'numberingSystem' | 'savedDisabled' | 'scale' | 'storageId' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteColorPickerElement> {
...
interface LuminaCalciteColorPickerHexInput extends Partial<Pick<ColorPickerHexInput, 'allowEmpty' | 'alphaChannel' | 'hexLabel' | 'numberingSystem' | 'scale' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteColorPickerHexInputElement> {
  oncalciteColorPickerHexInputChange?: EventHandler<HTMLCalciteColorPickerHexInputElement["calciteColorPickerHexInputChange"]>;
}

interface LuminaCalciteColorPickerSwatch extends Partial<Pick<ColorPickerSwatch, 'active' | 'color' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteColorPickerSwatchElement> {
}

interface LuminaCalciteCombobox extends Required<Pick<Combobox, 'label'>>, Partial<Pick<Combobox, 'allowCustomValues' | 'clearDisabled' | 'disabled' | 'filterProps' | 'filterText' | 'flipPlacements' | 'form' | 'maxItems' | 'messageOverrides' | 'name' | 'open' | 'overlayPositioning' | 'placeholder' | 'placeholderIcon' | 'placeholderIconFlipRtl' | 'readOnly' | 'required' | 'scale' | 'selectionDisplay' | 'selectionMode' | 'status' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteComboboxElement> {
...
interface LuminaCalciteComboboxItem extends Required<Pick<ComboboxItem, 'value'>>, Partial<Pick<ComboboxItem, 'active' | 'ancestors' | 'description' | 'disabled' | 'filterDisabled' | 'guid' | 'heading' | 'icon' | 'iconFlipRtl' | 'label' | 'metadata' | 'selected' | 'shortHeading' | 'textLabel'>>, h.JSX.HTMLAttributes<HTMLCalciteComboboxItemElement> {
  oncalciteComboboxItemChange?: EventHandler<HTMLCalciteComboboxItemElement["calciteComboboxItemChange"]>;
}

interface LuminaCalciteComboboxItemGroup extends Required<Pick<ComboboxItemGroup, 'label'>>, Partial<Pick<ComboboxItemGroup, 'ancestors'>>, h.JSX.HTMLAttributes<HTMLCalciteComboboxItemGroupElement> {
}

interface LuminaCalciteDatePicker extends Partial<Pick<DatePicker, 'activeDate' | 'activeRange' | 'headingLevel' | 'layout' | 'max' | 'maxAsDate' | 'messageOverrides' | 'min' | 'minAsDate' | 'monthStyle' | 'numberingSystem' | 'proximitySelectionDisabled' | 'range' | 'scale' | 'value' | 'valueAsDate'>>, h.JSX.HTMLAttributes<HTMLCalciteDatePickerElement> {
...
interface LuminaCalciteDatePickerDay extends Required<Pick<DatePickerDay, 'day'>>, Partial<Pick<DatePickerDay, 'active' | 'currentMonth' | 'disabled' | 'endOfRange' | 'highlighted' | 'range' | 'rangeHover' | 'scale' | 'selected' | 'startOfRange' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteDatePickerDayElement> {
}

interface LuminaCalciteDatePickerMonth extends Partial<Pick<DatePickerMonth, 'activeDate' | 'endDate' | 'headingLevel' | 'hoverRange' | 'max' | 'min' | 'monthStyle' | 'range' | 'scale' | 'selectedDate' | 'startDate'>>, h.JSX.HTMLAttributes<HTMLCalciteDatePickerMonthElement> {
}

interface LuminaCalciteDatePickerMonthHeader extends Partial<Pick<DatePickerMonthHeader, 'activeDate' | 'headingLevel' | 'localeData' | 'max' | 'min' | 'monthStyle' | 'scale' | 'selectedDate'>>, h.JSX.HTMLAttributes<HTMLCalciteDatePickerMonthHeaderElement> {
}

interface LuminaCalciteDialog extends Partial<Pick<Dialog, 'beforeClose' | 'closeDisabled' | 'description' | 'dragEnabled' | 'escapeDisabled' | 'focusTrapDisabled' | 'focusTrapOptions' | 'heading' | 'headingLevel' | 'kind' | 'loading' | 'menuOpen' | 'messageOverrides' | 'modal' | 'open' | 'outsideCloseDisabled' | 'overlayPositioning' | 'placement' | 'resizable' | 'scale' | 'width' | 'widthScale'>>, h.JSX.HTMLAttributes<HTMLCalciteDialogElement> {
...
interface LuminaCalciteDropdown extends Partial<Pick<Dropdown, 'closeOnSelectDisabled' | 'disabled' | 'flipPlacements' | 'maxItems' | 'offsetDistance' | 'offsetSkidding' | 'open' | 'overlayPositioning' | 'placement' | 'scale' | 'type' | 'width' | 'widthScale'>>, h.JSX.HTMLAttributes<HTMLCalciteDropdownElement> {
...
interface LuminaCalciteDropdownGroup extends Partial<Pick<DropdownGroup, 'groupTitle' | 'position' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteDropdownGroupElement> {
}

interface LuminaCalciteDropdownItem extends Partial<Pick<DropdownItem, 'disabled' | 'href' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'rel' | 'selected' | 'target'>>, h.JSX.HTMLAttributes<HTMLCalciteDropdownItemElement> {
  oncalciteDropdownItemSelect?: EventHandler<HTMLCalciteDropdownItemElement["calciteDropdownItemSelect"]>;
}

interface LuminaCalciteFab extends Partial<Pick<Fab, 'appearance' | 'disabled' | 'icon' | 'iconFlipRtl' | 'kind' | 'label' | 'loading' | 'scale' | 'text' | 'textEnabled'>>, h.JSX.HTMLAttributes<HTMLCalciteFabElement> {
}

interface LuminaCalciteFilter extends Partial<Pick<Filter, 'disabled' | 'filterProps' | 'items' | 'label' | 'messageOverrides' | 'placeholder' | 'scale' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteFilterElement> {
  oncalciteFilterChange?: EventHandler<HTMLCalciteFilterElement["calciteFilterChange"]>;
}

interface LuminaCalciteFlow extends h.JSX.HTMLAttributes<HTMLCalciteFlowElement> {
}

interface LuminaCalciteFlowItem extends Partial<Pick<FlowItem, 'beforeBack' | 'beforeClose' | 'closable' | 'closed' | 'collapsed' | 'collapsible' | 'description' | 'disabled' | 'heading' | 'headingLevel' | 'loading' | 'menuOpen' | 'messageOverrides' | 'overlayPositioning' | 'scale' | 'selected' | 'showBackButton'>>, h.JSX.HTMLAttributes<HTMLCalciteFlowItemElement> {
...
interface LuminaCalciteGraph extends Required<Pick<Graph, 'max' | 'min'>>, Partial<Pick<Graph, 'colorStops' | 'data' | 'highlightMax' | 'highlightMin'>>, h.JSX.HTMLAttributes<HTMLCalciteGraphElement> {
}

interface LuminaCalciteHandle extends Partial<Pick<Handle, 'disabled' | 'dragHandle' | 'messageOverrides' | 'selected'>>, h.JSX.HTMLAttributes<HTMLCalciteHandleElement> {
...
interface LuminaCalciteIcon extends Partial<Pick<Icon, 'flipRtl' | 'icon' | 'preload' | 'scale' | 'textLabel'>>, h.JSX.HTMLAttributes<HTMLCalciteIconElement> {
}

interface LuminaCalciteInlineEditable extends Partial<Pick<InlineEditable, 'afterConfirm' | 'controls' | 'disabled' | 'editingEnabled' | 'loading' | 'messageOverrides' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteInlineEditableElement> {
...
interface LuminaCalciteInput extends Partial<Pick<Input, 'accept' | 'alignment' | 'autocomplete' | 'clearable' | 'disabled' | 'files' | 'form' | 'groupSeparator' | 'icon' | 'iconFlipRtl' | 'label' | 'loading' | 'max' | 'maxLength' | 'messageOverrides' | 'min' | 'minLength' | 'multiple' | 'name' | 'numberButtonType' | 'numberingSystem' | 'pattern' | 'placeholder' | 'prefixText' | 'readOnly' | 'required' | 'scale' | 'status' | 'step' | 'suffixText' | 'type' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteInputElement> {
...
interface LuminaCalciteInputDatePicker extends Partial<Pick<InputDatePicker, 'disabled' | 'flipPlacements' | 'focusTrapDisabled' | 'form' | 'headingLevel' | 'layout' | 'max' | 'maxAsDate' | 'messageOverrides' | 'min' | 'minAsDate' | 'monthStyle' | 'name' | 'numberingSystem' | 'open' | 'overlayPositioning' | 'placement' | 'proximitySelectionDisabled' | 'range' | 'readOnly' | 'required' | 'scale' | 'status' | 'validationIcon' | 'validationMessage' | 'value' | 'valueAsDate'>>, h.JSX.HTMLAttributes<HTMLCalciteInputDatePickerElement> {
...
interface LuminaCalciteInputMessage extends Partial<Pick<InputMessage, 'icon' | 'iconFlipRtl' | 'scale' | 'status'>>, h.JSX.HTMLAttributes<HTMLCalciteInputMessageElement> {
}

interface LuminaCalciteInputNumber extends Partial<Pick<InputNumber, 'alignment' | 'autocomplete' | 'clearable' | 'disabled' | 'form' | 'groupSeparator' | 'icon' | 'iconFlipRtl' | 'integer' | 'label' | 'loading' | 'max' | 'maxLength' | 'messageOverrides' | 'min' | 'minLength' | 'name' | 'numberButtonType' | 'numberingSystem' | 'placeholder' | 'prefixText' | 'readOnly' | 'required' | 'scale' | 'status' | 'step' | 'suffixText' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteInputNumberElement> {
...
interface LuminaCalciteInputText extends Partial<Pick<InputText, 'alignment' | 'autocomplete' | 'clearable' | 'disabled' | 'form' | 'icon' | 'iconFlipRtl' | 'label' | 'loading' | 'maxLength' | 'messageOverrides' | 'minLength' | 'name' | 'pattern' | 'placeholder' | 'prefixText' | 'readOnly' | 'required' | 'scale' | 'status' | 'suffixText' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteInputTextElement> {
...
interface LuminaCalciteInputTimePicker extends Partial<Pick<InputTimePicker, 'disabled' | 'focusTrapDisabled' | 'form' | 'hourFormat' | 'max' | 'messageOverrides' | 'min' | 'name' | 'numberingSystem' | 'open' | 'overlayPositioning' | 'placement' | 'readOnly' | 'required' | 'scale' | 'status' | 'step' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteInputTimePickerElement> {
...
interface LuminaCalciteInputTimeZone extends Partial<Pick<InputTimeZone, 'clearable' | 'disabled' | 'form' | 'maxItems' | 'messageOverrides' | 'mode' | 'name' | 'offsetStyle' | 'open' | 'overlayPositioning' | 'readOnly' | 'referenceDate' | 'scale' | 'status' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteInputTimeZoneElement> {
...
interface LuminaCalciteLabel extends Partial<Pick<Label, 'alignment' | 'for' | 'layout' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteLabelElement> {
}

interface LuminaCalciteLink extends Partial<Pick<Link, 'disabled' | 'download' | 'href' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'rel' | 'target'>>, h.JSX.HTMLAttributes<HTMLCalciteLinkElement> {
}

interface LuminaCalciteList extends Required<Pick<List, 'label'>>, Partial<Pick<List, 'canPull' | 'canPut' | 'disabled' | 'displayMode' | 'dragEnabled' | 'filterEnabled' | 'filterLabel' | 'filterPlaceholder' | 'filterPredicate' | 'filterProps' | 'filterText' | 'group' | 'interactionMode' | 'loading' | 'messageOverrides' | 'numberingSystem' | 'scale' | 'selectionAppearance' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteListElement> {
...
interface LuminaCalciteListItem extends Partial<Pick<ListItem, 'closable' | 'closed' | 'description' | 'disabled' | 'dragDisabled' | 'expanded' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'messageOverrides' | 'metadata' | 'open' | 'scale' | 'selected' | 'sortHandleOpen' | 'unavailable' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteListItemElement> {
...
interface LuminaCalciteListItemGroup extends Partial<Pick<ListItemGroup, 'disabled' | 'heading' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteListItemGroupElement> {
}

interface LuminaCalciteLoader extends Required<Pick<Loader, 'label'>>, Partial<Pick<Loader, 'inline' | 'scale' | 'text' | 'type' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteLoaderElement> {
}

interface LuminaCalciteMenu extends Required<Pick<Menu, 'label'>>, Partial<Pick<Menu, 'layout' | 'messageOverrides'>>, h.JSX.HTMLAttributes<HTMLCalciteMenuElement> {
}

interface LuminaCalciteMenuItem extends Required<Pick<MenuItem, 'label'>>, Partial<Pick<MenuItem, 'active' | 'breadcrumb' | 'href' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'messageOverrides' | 'open' | 'rel' | 'target' | 'text'>>, h.JSX.HTMLAttributes<HTMLCalciteMenuItemElement> {
  oncalciteMenuItemSelect?: EventHandler<HTMLCalciteMenuItemElement["calciteMenuItemSelect"]>;
}

interface LuminaCalciteMeter extends Required<Pick<Meter, 'label'>>, Partial<Pick<Meter, 'appearance' | 'disabled' | 'fillType' | 'form' | 'groupSeparator' | 'high' | 'low' | 'max' | 'min' | 'name' | 'numberingSystem' | 'rangeLabels' | 'rangeLabelType' | 'scale' | 'unitLabel' | 'value' | 'valueLabel' | 'valueLabelType'>>, h.JSX.HTMLAttributes<HTMLCalciteMeterElement> {
}

interface LuminaCalciteModal extends Partial<Pick<Modal, 'beforeClose' | 'closeButtonDisabled' | 'docked' | 'escapeDisabled' | 'focusTrapDisabled' | 'focusTrapOptions' | 'fullscreen' | 'kind' | 'messageOverrides' | 'open' | 'outsideCloseDisabled' | 'scale' | 'widthScale'>>, h.JSX.HTMLAttributes<HTMLCalciteModalElement> {
...
interface LuminaCalciteNavigation extends Partial<Pick<Navigation, 'label' | 'navigationAction'>>, h.JSX.HTMLAttributes<HTMLCalciteNavigationElement> {
  oncalciteNavigationActionSelect?: EventHandler<HTMLCalciteNavigationElement["calciteNavigationActionSelect"]>;
}

interface LuminaCalciteNavigationLogo extends Partial<Pick<NavigationLogo, 'active' | 'description' | 'heading' | 'headingLevel' | 'href' | 'icon' | 'iconFlipRtl' | 'label' | 'rel' | 'target' | 'thumbnail'>>, h.JSX.HTMLAttributes<HTMLCalciteNavigationLogoElement> {
}

interface LuminaCalciteNavigationUser extends Partial<Pick<NavigationUser, 'active' | 'fullName' | 'label' | 'textDisabled' | 'thumbnail' | 'userId' | 'username'>>, h.JSX.HTMLAttributes<HTMLCalciteNavigationUserElement> {
}

interface LuminaCalciteNotice extends Partial<Pick<Notice, 'closable' | 'icon' | 'iconFlipRtl' | 'kind' | 'messageOverrides' | 'open' | 'scale' | 'width'>>, h.JSX.HTMLAttributes<HTMLCalciteNoticeElement> {
...
interface LuminaCalciteOption extends Partial<Pick<Option, 'disabled' | 'label' | 'selected' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteOptionElement> {
}

interface LuminaCalciteOptionGroup extends Required<Pick<OptionGroup, 'label'>>, Partial<Pick<OptionGroup, 'disabled'>>, h.JSX.HTMLAttributes<HTMLCalciteOptionGroupElement> {
}

interface LuminaCalcitePagination extends Partial<Pick<Pagination, 'groupSeparator' | 'messageOverrides' | 'numberingSystem' | 'pageSize' | 'scale' | 'startItem' | 'totalItems'>>, h.JSX.HTMLAttributes<HTMLCalcitePaginationElement> {
  oncalcitePaginationChange?: EventHandler<HTMLCalcitePaginationElement["calcitePaginationChange"]>;
}

interface LuminaCalcitePanel extends Partial<Pick<Panel, 'beforeClose' | 'closable' | 'closed' | 'collapsed' | 'collapsible' | 'description' | 'disabled' | 'heading' | 'headingLevel' | 'loading' | 'menuFlipPlacements' | 'menuOpen' | 'menuPlacement' | 'messageOverrides' | 'overlayPositioning' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalcitePanelElement> {
...
interface LuminaCalciteProgress extends Partial<Pick<Progress, 'label' | 'reversed' | 'text' | 'type' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteProgressElement> {
}

interface LuminaCalciteRadioButton extends Required<Pick<RadioButton, 'value'>>, Partial<Pick<RadioButton, 'checked' | 'disabled' | 'form' | 'name' | 'required' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteRadioButtonElement> {
  oncalciteRadioButtonChange?: EventHandler<HTMLCalciteRadioButtonElement["calciteRadioButtonChange"]>;
}

interface LuminaCalciteRadioButtonGroup extends Required<Pick<RadioButtonGroup, 'name'>>, Partial<Pick<RadioButtonGroup, 'disabled' | 'layout' | 'required' | 'scale' | 'status' | 'validationIcon' | 'validationMessage'>>, h.JSX.HTMLAttributes<HTMLCalciteRadioButtonGroupElement> {
  oncalciteRadioButtonGroupChange?: EventHandler<HTMLCalciteRadioButtonGroupElement["calciteRadioButtonGroupChange"]>;
}

interface LuminaCalciteRating extends Partial<Pick<Rating, 'average' | 'count' | 'disabled' | 'form' | 'messageOverrides' | 'name' | 'readOnly' | 'scale' | 'showChip' | 'status' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteRatingElement> {
  oncalciteRatingChange?: EventHandler<HTMLCalciteRatingElement["calciteRatingChange"]>;
}

interface LuminaCalciteScrim extends Partial<Pick<Scrim, 'loading' | 'messageOverrides'>>, h.JSX.HTMLAttributes<HTMLCalciteScrimElement> {
}

interface LuminaCalciteSegmentedControl extends Partial<Pick<SegmentedControl, 'appearance' | 'disabled' | 'form' | 'layout' | 'name' | 'required' | 'scale' | 'status' | 'validationIcon' | 'validationMessage' | 'value' | 'width'>>, h.JSX.HTMLAttributes<HTMLCalciteSegmentedControlElement> {
  oncalciteSegmentedControlChange?: EventHandler<HTMLCalciteSegmentedControlElement["calciteSegmentedControlChange"]>;
}

interface LuminaCalciteSegmentedControlItem extends Partial<Pick<SegmentedControlItem, 'checked' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteSegmentedControlItemElement> {
}

interface LuminaCalciteSelect extends Required<Pick<Select, 'label'>>, Partial<Pick<Select, 'disabled' | 'form' | 'name' | 'required' | 'scale' | 'status' | 'validationIcon' | 'validationMessage' | 'value' | 'width'>>, h.JSX.HTMLAttributes<HTMLCalciteSelectElement> {
  oncalciteSelectChange?: EventHandler<HTMLCalciteSelectElement["calciteSelectChange"]>;
}

interface LuminaCalciteSheet extends Required<Pick<Sheet, 'label'>>, Partial<Pick<Sheet, 'beforeClose' | 'displayMode' | 'escapeDisabled' | 'focusTrapDisabled' | 'focusTrapOptions' | 'height' | 'heightScale' | 'messageOverrides' | 'open' | 'outsideCloseDisabled' | 'position' | 'resizable' | 'width' | 'widthScale'>>, h.JSX.HTMLAttributes<HTMLCalciteSheetElement> {
...
interface LuminaCalciteShell extends Partial<Pick<Shell, 'contentBehind'>>, h.JSX.HTMLAttributes<HTMLCalciteShellElement> {
}

interface LuminaCalciteShellCenterRow extends Partial<Pick<ShellCenterRow, 'detached' | 'heightScale' | 'position'>>, h.JSX.HTMLAttributes<HTMLCalciteShellCenterRowElement> {
}

interface LuminaCalciteShellPanel extends Partial<Pick<ShellPanel, 'collapsed' | 'displayMode' | 'height' | 'heightScale' | 'layout' | 'messageOverrides' | 'position' | 'resizable' | 'width' | 'widthScale'>>, h.JSX.HTMLAttributes<HTMLCalciteShellPanelElement> {
}

interface LuminaCalciteSlider extends Partial<Pick<Slider, 'disabled' | 'fillPlacement' | 'form' | 'groupSeparator' | 'hasHistogram' | 'histogram' | 'histogramStops' | 'labelFormatter' | 'labelHandles' | 'labelTicks' | 'max' | 'maxLabel' | 'maxValue' | 'min' | 'minLabel' | 'minValue' | 'mirrored' | 'name' | 'numberingSystem' | 'pageStep' | 'precise' | 'required' | 'scale' | 'snap' | 'status' | 'step' | 'ticks' | 'validationIcon' | 'validationMessage' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteSliderElement> {
...
interface LuminaCalciteSortHandle extends Partial<Pick<SortHandle, 'disabled' | 'flipPlacements' | 'label' | 'messageOverrides' | 'moveToItems' | 'open' | 'overlayPositioning' | 'placement' | 'scale' | 'setPosition' | 'setSize' | 'widthScale'>>, h.JSX.HTMLAttributes<HTMLCalciteSortHandleElement> {
...
interface LuminaCalciteSortableList extends Partial<Pick<SortableList, 'canPull' | 'canPut' | 'disabled' | 'dragSelector' | 'group' | 'handleSelector' | 'layout' | 'loading'>>, h.JSX.HTMLAttributes<HTMLCalciteSortableListElement> {
...
interface LuminaCalciteStack extends Partial<Pick<Stack, 'disabled'>>, h.JSX.HTMLAttributes<HTMLCalciteStackElement> {
}

interface LuminaCalciteStepper extends Partial<Pick<Stepper, 'icon' | 'layout' | 'messageOverrides' | 'numbered' | 'numberingSystem' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteStepperElement> {
...
interface LuminaCalciteStepperItem extends Partial<Pick<StepperItem, 'complete' | 'description' | 'disabled' | 'error' | 'heading' | 'iconFlipRtl' | 'messageOverrides' | 'selected'>>, h.JSX.HTMLAttributes<HTMLCalciteStepperItemElement> {
  oncalciteStepperItemSelect?: EventHandler<HTMLCalciteStepperItemElement["calciteStepperItemSelect"]>;
}

interface LuminaCalciteSwitch extends Partial<Pick<Switch, 'checked' | 'disabled' | 'form' | 'label' | 'name' | 'scale' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteSwitchElement> {
  oncalciteSwitchChange?: EventHandler<HTMLCalciteSwitchElement["calciteSwitchChange"]>;
}

interface LuminaCalciteTab extends Partial<Pick<Tab, 'selected' | 'tab'>>, h.JSX.HTMLAttributes<HTMLCalciteTabElement> {
}

interface LuminaCalciteTabNav extends Partial<Pick<TabNav, 'messageOverrides' | 'position' | 'storageId' | 'syncId'>>, h.JSX.HTMLAttributes<HTMLCalciteTabNavElement> {
  oncalciteTabChange?: EventHandler<HTMLCalciteTabNavElement["calciteTabChange"]>;
}

interface LuminaCalciteTabTitle extends Partial<Pick<TabTitle, 'closable' | 'closed' | 'disabled' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'messageOverrides' | 'position' | 'selected' | 'tab'>>, h.JSX.HTMLAttributes<HTMLCalciteTabTitleElement> {
...
interface LuminaCalciteTable extends Required<Pick<Table, 'caption'>>, Partial<Pick<Table, 'bordered' | 'groupSeparator' | 'interactionMode' | 'layout' | 'messageOverrides' | 'numbered' | 'numberingSystem' | 'pageSize' | 'scale' | 'selectionDisplay' | 'selectionMode' | 'striped'>>, h.JSX.HTMLAttributes<HTMLCalciteTableElement> {
...
interface LuminaCalciteTableCell extends Partial<Pick<TableCell, 'alignment' | 'colSpan' | 'messageOverrides' | 'rowSpan'>>, h.JSX.HTMLAttributes<HTMLCalciteTableCellElement> {
}

interface LuminaCalciteTableHeader extends Partial<Pick<TableHeader, 'alignment' | 'colSpan' | 'description' | 'heading' | 'messageOverrides' | 'rowSpan'>>, h.JSX.HTMLAttributes<HTMLCalciteTableHeaderElement> {
}

interface LuminaCalciteTableRow extends Partial<Pick<TableRow, 'alignment' | 'disabled' | 'selected'>>, h.JSX.HTMLAttributes<HTMLCalciteTableRowElement> {
  oncalciteTableRowSelect?: EventHandler<HTMLCalciteTableRowElement["calciteTableRowSelect"]>;
}

interface LuminaCalciteTabs extends Partial<Pick<Tabs, 'bordered' | 'layout' | 'position' | 'scale'>>, h.JSX.HTMLAttributes<HTMLCalciteTabsElement> {
}

interface LuminaCalciteTextArea extends Partial<Pick<TextArea, 'columns' | 'disabled' | 'form' | 'groupSeparator' | 'label' | 'limitText' | 'maxLength' | 'messageOverrides' | 'minLength' | 'name' | 'numberingSystem' | 'placeholder' | 'readOnly' | 'required' | 'resize' | 'rows' | 'scale' | 'status' | 'validationIcon' | 'validationMessage' | 'value' | 'wrap'>>, h.JSX.HTMLAttributes<HTMLCalciteTextAreaElement> {
...
interface LuminaCalciteTile extends Partial<Pick<Tile, 'active' | 'alignment' | 'description' | 'disabled' | 'embed' | 'heading' | 'href' | 'icon' | 'iconFlipRtl' | 'label' | 'scale' | 'selected'>>, h.JSX.HTMLAttributes<HTMLCalciteTileElement> {
  oncalciteTileSelect?: EventHandler<HTMLCalciteTileElement["calciteTileSelect"]>;
}

interface LuminaCalciteTileGroup extends Required<Pick<TileGroup, 'label'>>, Partial<Pick<TileGroup, 'alignment' | 'disabled' | 'layout' | 'scale' | 'selectionAppearance' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteTileGroupElement> {
  oncalciteTileGroupSelect?: EventHandler<HTMLCalciteTileGroupElement["calciteTileGroupSelect"]>;
}

interface LuminaCalciteTileSelect extends Partial<Pick<TileSelect, 'checked' | 'description' | 'disabled' | 'heading' | 'icon' | 'iconFlipRtl' | 'inputAlignment' | 'inputEnabled' | 'name' | 'type' | 'value' | 'width'>>, h.JSX.HTMLAttributes<HTMLCalciteTileSelectElement> {
  oncalciteTileSelectChange?: EventHandler<HTMLCalciteTileSelectElement["calciteTileSelectChange"]>;
}

interface LuminaCalciteTileSelectGroup extends Partial<Pick<TileSelectGroup, 'disabled' | 'layout'>>, h.JSX.HTMLAttributes<HTMLCalciteTileSelectGroupElement> {
}

interface LuminaCalciteTimePicker extends Partial<Pick<TimePicker, 'hourFormat' | 'messageOverrides' | 'numberingSystem' | 'scale' | 'step' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteTimePickerElement> {
  oncalciteTimePickerChange?: EventHandler<HTMLCalciteTimePickerElement["calciteTimePickerChange"]>;
}

interface LuminaCalciteTip extends Partial<Pick<Tip, 'closed' | 'closeDisabled' | 'heading' | 'headingLevel' | 'messageOverrides' | 'selected'>>, h.JSX.HTMLAttributes<HTMLCalciteTipElement> {
  oncalciteTipDismiss?: EventHandler<HTMLCalciteTipElement["calciteTipDismiss"]>;
}

interface LuminaCalciteTipGroup extends Partial<Pick<TipGroup, 'groupTitle'>>, h.JSX.HTMLAttributes<HTMLCalciteTipGroupElement> {
}

interface LuminaCalciteTipManager extends Partial<Pick<TipManager, 'closed' | 'headingLevel' | 'messageOverrides'>>, h.JSX.HTMLAttributes<HTMLCalciteTipManagerElement> {
  oncalciteTipManagerClose?: EventHandler<HTMLCalciteTipManagerElement["calciteTipManagerClose"]>;
}

interface LuminaCalciteTooltip extends Partial<Pick<Tooltip, 'closeOnClick' | 'label' | 'offsetDistance' | 'offsetSkidding' | 'open' | 'overlayPositioning' | 'placement' | 'referenceElement'>>, h.JSX.HTMLAttributes<HTMLCalciteTooltipElement> {
...
interface LuminaCalciteTree extends Partial<Pick<Tree, 'lines' | 'scale' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteTreeElement> {
  oncalciteTreeSelect?: EventHandler<HTMLCalciteTreeElement["calciteTreeSelect"]>;
}

interface LuminaCalciteTreeItem extends Partial<Pick<TreeItem, 'disabled' | 'expanded' | 'iconFlipRtl' | 'iconStart' | 'label' | 'selected'>>, h.JSX.HTMLAttributes<HTMLCalciteTreeItemElement> {
}
...
declare module "@arcgis/lumina" {
  export namespace h.JSX {
    interface IntrinsicElements {
      ...
      "calcite-date-picker-month-header": LuminaCalciteDatePickerMonthHeader;
      ...
      "calcite-modal": LuminaCalciteModal;
      ...
      "calcite-shell-center-row": LuminaCalciteShellCenterRow;
      ...
      "calcite-tile-select": LuminaCalciteTileSelect;
      "calcite-tile-select-group": LuminaCalciteTileSelectGroup;
      "calcite-time-picker": LuminaCalciteTimePicker;
      "calcite-tip": LuminaCalciteTip;
      "calcite-tip-group": LuminaCalciteTipGroup;
      "calcite-tip-manager": LuminaCalciteTipManager;
