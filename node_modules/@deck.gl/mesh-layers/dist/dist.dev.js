  ...
  function interpolate(time, { input, interpolation, output }, target, path) {
    ...
    if (!Array.isArray(target[path])) {
      switch (path) {
        ...
        case "scale":
          ...
          break;
        default:
          import_core7.log.warn(`Bad animation path ${path}`)();
      }
    }
    ...
    switch (interpolation) {
      ...
      case "CUBICSPLINE":
        ...
        break;
      default:
        import_core7.log.warn(`Interpolation ${interpolation} not supported`)();
        break;
    }
  }
...
`
  ...
  function createGLTFModel(device, options) {
    ...
    import_core9.log.info(4, "createGLTFModel defines: ", parsedMaterial.defines)();
  ...
  var VERSION4 = true ? "4.2.1" : "latest";
  ...
  var Vector2 = class extends MathArray2 {
    // ACCESSORS
    get x() {
      return this[0];
    }
  ...
  function rotateX3(out, a2, b, rad) {
    const p2 = [];
    const r2 = [];
    p2[0] = a2[0] - b[0];
    p2[1] = a2[1] - b[1];
  ...
  function rotateY3(out, a2, b, rad) {
    const p2 = [];
    const r2 = [];
    p2[0] = a2[0] - b[0];
    p2[1] = a2[1] - b[1];
  ...
  function rotateZ3(out, a2, b, rad) {
    const p2 = [];
    const r2 = [];
    p2[0] = a2[0] - b[0];
    p2[1] = a2[1] - b[1];
  ...
  function angle(a2, b) {
    ...
    const cosine = mag && dot4(a2, b) / mag;
  ...
  var ORIGIN = [0, 0, 0];
  var ZERO3;
  var Vector3 = class extends Vector2 {
    static get ZERO() {
      if (!ZERO3) {
    ...
    rotateX({ radians, origin = ORIGIN }) {
      rotateX3(this, this, origin, radians);
      return this.check();
    }
    rotateY({ radians, origin = ORIGIN }) {
      rotateY3(this, this, origin, radians);
      return this.check();
    }
    rotateZ({ radians, origin = ORIGIN }) {
      rotateZ3(this, this, origin, radians);
      return this.check();
    }
    // Transforms
  ...
  var Matrix3 = class extends Matrix2 {
    static get IDENTITY() {
...
`;
  ...
  var ScenegraphLayer = class extends import_core12.Layer {
    getShaders() {
      const defines = {};
      let pbr;
      ...
      const modules = [import_core12.project32, import_core12.picking, scenegraphUniforms, pbr];
    ...
    _updateScenegraph() {
      ...
      if (scenegraph instanceof import_engine4.GroupNode) {
        ...
        import_core12.log.warn("invalid scenegraph:", scenegraph)();
      }
    }
      ...
      Object.keys(animationsProp).sort().forEach((key) => {
        ...
        if (key === "*") {
          ...
          if (number >= 0 && number < animations.length) {
            ...
            import_core12.log.warn(`animation ${key} not found`)();
          }
        } else {
