...
function u(e, t, n, o, i2, u2) {
  ...
  var l2 = { type: e, props: p, key: n, ref: a, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --f, __i: -1, __u: 0, __source: i2, __self: u2 };
...
var IconButton = (props) => {
  ...
  return u("div", { className: "deck-widget-button", children: u("button", { className: `deck-widget-icon-button ${className}`, type: "button", onClick, title: label, children: u("div", { className: "deck-widget-icon" }) }) });
};
var ButtonGroup = (props) => {
  const { children, orientation } = props;
  return u("div", { className: `deck-widget-button-group ${orientation}`, children });
};
var GroupedIconButton = (props) => {
  const { className, label, onClick } = props;
  return u("button", { className: `deck-widget-icon-button ${className}`, type: "button", onClick, title: label, children: u("div", { className: "deck-widget-icon" }) });
};
...
var FullscreenWidget = class {
  ...
  update() {
    ...
    const ui = u(IconButton, { onClick: this.handleClick.bind(this), label: this.fullscreen ? exitLabel : enterLabel, className: this.fullscreen ? "deck-widget-fullscreen-exit" : "deck-widget-fullscreen-enter" });
    E(ui, element);
  }
  setProps(props) {
    this.placement = props.placement ?? this.placement;
...
var CompassWidget = class {
  ...
  update() {
    ...
    const ui = u("div", { className: "deck-widget-button", style: { perspective: 100 }, children: u("button", { type: "button", onClick: () => {
      for (const viewport2 of Object.values(this.viewports)) {
        this.handleCompassReset(viewport2);
      }
    }, title: this.props.label, style: { transform: `rotateX(${rx}deg)` }, children: u("svg", { fill: "none", width: "100%", height: "100%", viewBox: "0 0 26 26", children: u("g", { transform: `rotate(${rz},13,13)`, children: [u("path", { d: "M10 13.0001L12.9999 5L15.9997 13.0001H10Z", fill: "var(--icon-compass-north-color, #F05C44)" }), u("path", { d: "M16.0002 12.9999L13.0004 21L10.0005 12.9999H16.0002Z", fill: "var(--icon-compass-south-color, #C2C2CC)" })] }) }) }) });
    E(ui, element);
  }
  onRemove() {
    this.deck = void 0;
...
var ZoomWidget = class _ZoomWidget {
  ...
  update() {
    ...
    const ui = u(ButtonGroup, { orientation: this.props.orientation, children: [u(GroupedIconButton, { onClick: () => this.handleZoomIn(), label: this.props.zoomInLabel, className: "deck-widget-zoom-in" }), u(GroupedIconButton, { onClick: () => this.handleZoomOut(), label: this.props.zoomOutLabel, className: "deck-widget-zoom-out" })] });
    E(ui, element);
  }
};
...
var ScreenshotWidget = class _ScreenshotWidget extends WidgetImpl {
  ...
  onRenderHTML() {
    ...
    if (!element)
      return;
    E(u(IconButton, { className: "deck-widget-camera", label: this.props.label, onClick: this.handleClick.bind(this) }), element);
  }
  handleClick() {
...
var ResetViewWidget = class _ResetViewWidget extends WidgetImpl {
  ...
  onRenderHTML() {
    ...
    if (!element)
      return;
    E(u(IconButton, { className: "deck-widget-reset-focus", label: this.props.label, onClick: this.handleClick.bind(this) }), element);
  }
  handleClick() {
    var _a;
...
//# sourceMappingURL=chunk-3VN5KK6O.js.map
