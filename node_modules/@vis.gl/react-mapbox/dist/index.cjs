...
// dist/utils/compare-class-names.js
...
function Source(props) {
  ...
  const forceUpdate = (0, import_react12.useCallback)(() => setStyleLoaded((version) => version + 1), []);
