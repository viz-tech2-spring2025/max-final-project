import { d as GenericController, B as BaseComponent, b as Controller, E as EventEmitter } from '../Controller-oDdp0LxM.cjs';
...
declare const accessorSupport: {
    ...
    watchAccessorUpdates<T>(controller: Controller<T> & {
        reactiveUtils: __esri.reactiveUtils;
    }, instance: __esri.Accessor, watchedProperties: Map<string, string>): void;
    reEmitAccessorEvents<T>(controller: Controller<T>, instance: __esri.Accessor, reactiveUtils: __esri.reactiveUtils, prefix: string): void;
...
export { AccessorController, accessorSupport, makeAccessorController, reEmitEvent };
